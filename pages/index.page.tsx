...
export default function Home() {
  ...
  const { currentAccount, getBal, sendTx, loading: web3Loading } = useWeb3Context();
  ...
  useEffect(() => {
    const initiate = async () => {
      ...
      const trans = await getBal(currentAccount, dybx);
      console.log(trans);
      const res = await sendTx(trans);
      console.log(res);
    };
